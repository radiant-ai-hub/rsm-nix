...
Run `rsm-setup` any time — it pulls the latest environment and rebuilds. It's
safe to re-run and never touches your coursework.

---

*Instructors / developers:* the flake interfaces, the full command list, the
directory layout, and the server configuration are in
